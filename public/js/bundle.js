...
var getData = function getData() {
  return axios.get('https://opentdb.com/api.php?amount=1&type=multiple').then(function (result) {
    return result.data;
  });
...
// DOM elements
var playBtn = document.getElementById('playBtn'); // const buttons = document.querySelectorAll('.btn-ans');
// Call API on load
...
var ans_a; // DATA delegation

var init = function init() {
  (0, _api.getData)().then(function (data) {
    var header = data.results[0].category.toUpperCase();
    var question = data.results[0].question;
    var level = data.results[0].difficulty.toUpperCase();
    ans_a = data.results[0].correct_answer;
    var ans_b = data.results[0].incorrect_answers[0];
    var ans_c = data.results[0].incorrect_answers[1];
    var ans_d = data.results[0].incorrect_answers[2]; // Debugging TEST
    ...
    var answers = [ans_a, ans_b, ans_c, ans_d];
    shuffle(answers); // DOM Elements
...
var btnA = document.getElementById('ans_a');
var btnB = document.getElementById('ans_b');
var btnC = document.getElementById('ans_c');
var btnD = document.getElementById('ans_d'); // Check option A

btnA.addEventListener('click', function () {
  var btnA = document.getElementById('ans_a').textContent;
...
btnB.addEventListener('click', function () {
  var btnB = document.getElementById('ans_b').textContent;
...
btnC.addEventListener('click', function () {
  var btnC = document.getElementById('ans_c').textContent;
...
btnD.addEventListener('click', function () {
  var btnD = document.getElementById('ans_d').textContent;
